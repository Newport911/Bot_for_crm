    ...
    try:
        async with httpx.AsyncClient() as client:
            ...
            if order_data["client"]["phone_number"] == phone_number:
                ...
                status_choices = {
                    'opl_na_proyavku': 'Статус вашего заказа: оплачен, в очереди на проявку! 🎞',
                    'opl_na_skan': 'Статус вашего заказа: оплачен, в очереди на сканирование! 🎞',
                    'opl_na_otpravku': 'Статус вашего заказа: оплачен, скоро будет отправлен на почту!',
                    'opl_na_pechat': 'Статус вашего заказа: оплачен, в очереди на печать! 🌠',
                    'opl_gotov': 'Статус вашего заказа: оплачен и готов 💫 Можно забирать!',
                    'opl_gotov_otpr': 'Статус вашего заказа: оплачен, готов и отправлен на e-mail 📩',
                    'opl_gotov_otpr_otdan': 'Статус вашего заказа: оплачен, готов, отправлен на e-mail и отдан вам 🙂',
                    'opl_gotov_otdan': 'Статус вашего заказа: оплачен, готов и отдан вам 🙂',
                    'no_gotov': 'Статус вашего заказа: не оплачен, готов',
                    'srchno_opl_na_proyavku': 'Статус вашего заказа: ⚡️срочный заказ⚡️, оплачен, в очереди на проявку!',
                    'srchno_opl_na_skan': 'Статус вашего заказа:⚡️срочный заказ⚡️, оплачен, в очереди на сканирование!',
                }
    ...
    if "products" in cache:
        ...
        try:
            async with httpx.AsyncClient() as client:
                ...
                product_list = "📦 **Доступные фотопленки:**\n\n"
